...
public class MultiplayerBuildAndRun
{
    ...
    #region Mac
    [UnityEditor.MenuItem("Tools/Run Multiplayer/Mac/1 Players")]
    static void PerformMacBuild1()
    {
        PerformMacBuild(1);
    }

    [UnityEditor.MenuItem("Tools/Run Multiplayer/Mac/2 Players")]
    static void PerformMacBuild2()
    {
        PerformMacBuild(2);
    }

    [UnityEditor.MenuItem("Tools/Run Multiplayer/Mac/3 Players")]
    static void PerformMacBuild3()
    {
        PerformMacBuild(3);
    }

    [UnityEditor.MenuItem("Tools/Run Multiplayer/Mac/4 Players")]
