...
public class Character : MonoBehaviourPunCallbacks
{
    ...
    //private new Collider collider; // 콜라이더
    ...
    void Awake()
    {
        ...
        //collider = GetComponent<Collider>(); // 콜라이더 가져오기
    ...
    void Update()
    {
        if (!PV.IsMine) return; // 이 플레이어의 컨트롤러가 아닌 경우 업데이트를 건너뜁니다.
        ...
        //    Debug.Log(block.liftedItems.Peek());
        //    Debug.Log(block.liftedItems.Count);
        //}
